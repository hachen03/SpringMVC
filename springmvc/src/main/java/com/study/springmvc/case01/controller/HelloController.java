...
public class HelloController {
       ...
       public String welcome() {
 	    ...
 	    */
       // 請設計方法api,結局會得到 bmi = 20.76 若資訊不足則不顯示
 	   @GetMapping(value= {"/bmi"})
 	   @ResponseBody
 	   public String calculate(@RequestParam(value= "h",required = false)Optional<Double> h,
 	    ...
 	    * 子路徑:/calc/sub?y=20      ->Result:0 - 20 = -10
 	    ...
 	    */
 	   	  ...
 	   	  /*
 	   	   * 8.得到多筆Java考試成績的資料(Lab練習)
 	   	   * 路徑:/javaexam?score=80&score=100&score=50
 	   	   * 求出最高分、最低分、平均與總分 = height: 100, low: 50,avg: 76.67,sum: 230
   	      */
 	   	  @GetMapping("javaexam")
 	   	  @ResponseBody
 	   	  public String testscore(@RequestParam("score")List<Integer> scores) {
 	   	   ...
 	   	   * 路徑:/person?name=Mary&score=90&lavel=2
 	   	   * 常與於各 form表單傳來的不統一參數
 	   	   */
